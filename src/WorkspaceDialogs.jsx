...
export function DataToolsDialog({
  ...
  return (
    <div className="modal-scrim" role="dialog" aria-modal="true" aria-label="Backup and export">
      <section className="adjustment-modal data-tools-modal">
...
export function SaveConceptDialog({ concepts, play, onClose, onSave }) {
  ...
  return (
    <div className="modal-scrim" role="dialog" aria-modal="true" aria-label="Save concept template">
...
export function ApplyConceptDialog({ concepts, currentConceptId, onApply, onClose }) {
  ...
  return (
    <div className="modal-scrim" role="dialog" aria-modal="true" aria-label="Apply concept template">
      <form className="adjustment-modal details-modal" onSubmit={(event) => {
        event.preventDefault();
