...
Backup SHA-256: `5aca4966b9b5d7bde3ed2fc45e0bf79523a4438619f70ce17c465a0c952936bd`.
...
Choose **Diagram** in the **Canvas background** dropdown beside Key (inside **Layers** on phones). This removes field markings except a thin LOS; **Field** restores them. Use **Export phone PNG** for larger defender labels and a spatially grouped legend: BC, S, FC above B, W, M, A. Diagram exports fit the complete lesson more tightly. Tokens and drop arrows match their areas; bubble tags remain unchanged. The review uses **Dim offense**. Background, dimming, and export format are view choices, not saved play fields. The owner accepted ownership clarity in the colored Field version; the owner prefers Diagram for teaching. Its legend now matches the charcoal surface and dimmed offense is brighter for visible receiver landmarks. No timed-edit or third-party understanding check is required.

Set **More → Play details → Field side** to None, Left, or Right. This is saved with the play and is undoable; existing plays default to None. The lesson uses Right and shows **FIELD →** in either background and PNG exports. In Sideline orientation the arrow rotates with the field. Two-page split stays deferred to the next lesson.
