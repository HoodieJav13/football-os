...
- The first complete authoring loop supports one active assignment per player. Multi-assignment sequencing is a later capability, not something to imply in the current UI.
